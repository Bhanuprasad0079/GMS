              ...
              >
                <div className="p-6">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-slate-600 dark:text-slate-300 text-sm mb-4 leading-relaxed bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-100 dark:border-slate-800">
                            {ticket.description}
                        </p>
